...
def test_metrics(monkeypatch):
    ...
    mock_sgp30_source = mock.Mock()
    mock_sgp30_source.get_air_quality.return_value = sgp30.SGP30Reading(412, 123)
    response = app.create_app(mock_sgp30_source).test_client().get("/metrics")
